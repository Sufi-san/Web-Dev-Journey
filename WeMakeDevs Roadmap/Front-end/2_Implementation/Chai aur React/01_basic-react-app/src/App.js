  ...
  return (
    <>
      ...
      <p>
        ...
        - To create a 'production' build that is deployed and is served to the users, we can use the following command for both vite and react --
            npm run build
